...
class PosteriorGSSMSmoothed(NamedTuple):
    ...
    smoothed_covariances: Float[Array, "ntime state_dim state_dim"] = None
    smoothed_covariances_0: Float[Array, "state_dim state_dim"] = None
    smoothed_covariances_p: Float[Array, "state_dim state_dim"] = None
    smoothed_covariances_n: Float[Array, "state_dim state_dim"] = None
...
def lgssm_smoother(
    ...
    def _step(carry, args):
        ...
        smoothed_outer = jnp.outer(smoothed_mean, smoothed_mean_next)

        return (smoothed_mean, smoothed_cov), (smoothed_mean, smoothed_cov, smoothed_cross, smoothed_outer)

    # Run the Kalman smoother
    _, (smoothed_means, smoothed_covs, smoothed_cross, smoothed_outer) = lax.scan(
        _step,
